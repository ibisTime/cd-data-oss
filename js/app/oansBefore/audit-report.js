 $(function() {
    ...
    var html,html1,html2,html3,html4,html5,infoBasic,
        infoContact,infoOccupation,infoBankcard,infoCarrier,
...
reqApi({
        ...
        if(data.infoCarrierFlag  !== "0" &&  data.infoContactFlag  !== "0" ){

            $('#CompatibleBtn').on('click',function(){
                window.location.href = 'https://tenant.51datakey.com/carrier/mxreport_data?data='+infoCarrier.message+'&contact='+infoContact.familyMobile+':'+ (infoContact.familyName?infoContact.familyName:'未知') +':'+ Dict.getNameForList1('family_relation','623907',infoContact.familyRelation) +','+ infoContact.societyMobile +':'+ (infoContact.societyName?infoContact.societyName:'未知') +':'+ Dict.getNameForList1('society_relation','623907',infoContact.societyRelation);

            })
            
        }else if(data.infoCarrierFlag  !== "0"){
            $('#CompatibleBtn').on('click',function(){
                window.location.href = 'https://tenant.51datakey.com/carrier/mxreport_data?data='+infoCarrier.message;
            })            
        }
